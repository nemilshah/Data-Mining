...
<div style="padding:30px" class="main_bg">
		...
		<p style=" font-size:50px; color:rgb(164, 175, 32); margin-left:10%">STUDENT LOG IN</h1><br><br>
...
$us= $_POST['emailid'];
		...
		$res = $con->query("select * from students where email ='$us'");
		echo $us;
		if($res->num_rows==0)
		{
		...
		{	
			...
			if(  $p==$_POST['password'])
			{
				...
				*/
                	...
                	$_SESSION['id']=$row['UID'];
                	$_SESSION['ftotal']=$row['final_total'];
				   echo '<script>window.location.assign("sprofile.php");</script>';
